...
public class TRenderDatum implements org.apache.thrift.TBase<TRenderDatum, TRenderDatum._Fields>, java.io.Serializable, Cloneable, Comparable<TRenderDatum> {
   ...
   */
  public com.stlogic.omnisci.thrift.server.TDatumType type; // required
  ...
  public TRenderDatum(
    com.stlogic.omnisci.thrift.server.TDatumType type,
    int cnt,
   ...
   * @see com.stlogic.omnisci.thrift.server.TDatumType
   */
  public com.stlogic.omnisci.thrift.server.TDatumType getType() {
    return this.type;
  }
   ...
   * @see com.stlogic.omnisci.thrift.server.TDatumType
   */
  public TRenderDatum setType(com.stlogic.omnisci.thrift.server.TDatumType type) {
    this.type = type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TYPE:
      if (value == null) {
        ...
        setType((com.stlogic.omnisci.thrift.server.TDatumType)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.stlogic.omnisci.thrift.server.TDatumType.findByValue(iprot.readI32());
