...
public class TTableMeta implements org.apache.thrift.TBase<TTableMeta, TTableMeta._Fields>, java.io.Serializable, Cloneable, Comparable<TTableMeta> {
  ...
  public java.util.List<com.stlogic.omnisci.thrift.server.TTypeInfo> col_types; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.COL_TYPES, new org.apache.thrift.meta_data.FieldMetaData("col_types", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.stlogic.omnisci.thrift.server.TTypeInfo.class))));
  ...
  public TTableMeta(
    ...
    long table_id,
    long max_table_id,
    java.util.List<com.stlogic.omnisci.thrift.server.TTypeInfo> col_types,
  ...
  public TTableMeta(TTableMeta other) {
    ...
    if (other.isSetCol_types()) {
      java.util.List<com.stlogic.omnisci.thrift.server.TTypeInfo> __this__col_types = new java.util.ArrayList<com.stlogic.omnisci.thrift.server.TTypeInfo>(other.col_types.size());
      for (com.stlogic.omnisci.thrift.server.TTypeInfo other_element : other.col_types) {
        __this__col_types.add(new com.stlogic.omnisci.thrift.server.TTypeInfo(other_element));
      }
  ...
  public java.util.Iterator<com.stlogic.omnisci.thrift.server.TTypeInfo> getCol_typesIterator() {
    return (this.col_types == null) ? null : this.col_types.iterator();
  }

  public void addToCol_types(com.stlogic.omnisci.thrift.server.TTypeInfo elem) {
    if (this.col_types == null) {
      this.col_types = new java.util.ArrayList<com.stlogic.omnisci.thrift.server.TTypeInfo>();
    }
    this.col_types.add(elem);
  }

  public java.util.List<com.stlogic.omnisci.thrift.server.TTypeInfo> getCol_types() {
    return this.col_types;
  }

  public TTableMeta setCol_types(java.util.List<com.stlogic.omnisci.thrift.server.TTypeInfo> col_types) {
    this.col_types = col_types;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case COL_TYPES:
      if (value == null) {
        ...
        setCol_types((java.util.List<com.stlogic.omnisci.thrift.server.TTypeInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.col_types = new java.util.ArrayList<com.stlogic.omnisci.thrift.server.TTypeInfo>(_list144.size);
                com.stlogic.omnisci.thrift.server.TTypeInfo _elem145;
                for (int _i146 = 0; _i146 < _list144.size; ++_i146)
                {
                  _elem145 = new com.stlogic.omnisci.thrift.server.TTypeInfo();
                  _elem145.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTableMeta struct) throws org.apache.thrift.TException {
      ...
      if (struct.col_types != null) {
        oprot.writeFieldBegin(COL_TYPES_FIELD_DESC);
        {
          ...
          for (com.stlogic.omnisci.thrift.server.TTypeInfo _iter150 : struct.col_types)
          {
      ...
      if (struct.isSetCol_types()) {
        {
          ...
          for (com.stlogic.omnisci.thrift.server.TTypeInfo _iter152 : struct.col_types)
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.col_types = new java.util.ArrayList<com.stlogic.omnisci.thrift.server.TTypeInfo>(_list154.size);
          com.stlogic.omnisci.thrift.server.TTypeInfo _elem155;
          for (int _i156 = 0; _i156 < _list154.size; ++_i156)
          {
            _elem155 = new com.stlogic.omnisci.thrift.server.TTypeInfo();
            _elem155.read(iprot);
