...
public class TTargetInfo implements org.apache.thrift.TBase<TTargetInfo, TTargetInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TTargetInfo> {
  ...
  public com.stlogic.omnisci.thrift.server.TTypeInfo type; // required
  public com.stlogic.omnisci.thrift.server.TTypeInfo arg_type; // required
  ...
  public TTargetInfo(
    boolean is_agg,
    TAggKind kind,
    com.stlogic.omnisci.thrift.server.TTypeInfo type,
    com.stlogic.omnisci.thrift.server.TTypeInfo arg_type,
    boolean skip_nulls,
    boolean is_distinct)
  {
    this();
  ...
  public TTargetInfo(TTargetInfo other) {
    ...
    if (other.isSetType()) {
      this.type = new com.stlogic.omnisci.thrift.server.TTypeInfo(other.type);
    }
    if (other.isSetArg_type()) {
      this.arg_type = new com.stlogic.omnisci.thrift.server.TTypeInfo(other.arg_type);
    }
  ...
  public com.stlogic.omnisci.thrift.server.TTypeInfo getType() {
    return this.type;
  }

  public TTargetInfo setType(com.stlogic.omnisci.thrift.server.TTypeInfo type) {
    this.type = type;
    return this;
  }
  ...
  public com.stlogic.omnisci.thrift.server.TTypeInfo getArg_type() {
    return this.arg_type;
  }

  public TTargetInfo setArg_type(com.stlogic.omnisci.thrift.server.TTypeInfo arg_type) {
    this.arg_type = arg_type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TYPE:
      if (value == null) {
        ...
        setType((com.stlogic.omnisci.thrift.server.TTypeInfo)value);
      }
      break;
    ...
    case ARG_TYPE:
      if (value == null) {
        ...
        setArg_type((com.stlogic.omnisci.thrift.server.TTypeInfo)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // KIND
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.kind = com.stlogic.omnisci.thrift.server.TAggKind.findByValue(iprot.readI32());
          ...
          case 3: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.type = new com.stlogic.omnisci.thrift.server.TTypeInfo();
          ...
          case 4: // ARG_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.arg_type = new com.stlogic.omnisci.thrift.server.TTypeInfo();
